...
public class Solitaire : MonoBehaviour
{
    ...
    public SpriteRenderer deckButtonSR;
    ...
    void Start()
    {
        ...
        PlayCards();
        //deckButtonSR = deckButton.GetComponent<SpriteRenderer>();
        //cardSR = newCard.GetComponent<SpriteRenderer>();
        //deckButtonSR.sprite = cardSR.sprite;
        
        GameObject deckCard = Instantiate(cardPrefab, new Vector3(-6, 3, 0), Quaternion.identity) as GameObject;
        deckCard.transform.localScale = new Vector3(0.45f,0.45f,1f);
        
        //deckButton.GetComponent<UpdateSprite>() = cardSR.sprite;
    }
